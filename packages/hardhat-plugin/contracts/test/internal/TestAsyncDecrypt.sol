...
contract TestAsyncDecrypt is SepoliaFHEVMConfig {
    ...
    euint64 public inputEuint64;
    bytes32 public inputEuint64Bytes32;
    ...
    function externalEuint64ToEuint64(externalEuint64 inputHandle, bytes calldata inputProof) public {
        inputEuint64 = FHE.fromExternal(inputHandle, inputProof);
