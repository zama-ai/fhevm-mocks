...
library LibForgeFhevmUpgrade {
     ...
     */
    function upgradeFromPreviousGeneration(address[10] memory addresses) internal view {
     ...
     */
    function upgradeCleartextFromPreviousGeneration(address[10] memory addresses) internal view returns (address, address) {
        IACL(addresses[uint8(FhevmAddressRole.ACL)]).owner();
        revert NoPreviousGeneration();
    }
