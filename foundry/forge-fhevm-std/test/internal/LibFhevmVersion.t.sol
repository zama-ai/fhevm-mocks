...
/// The version gate accepts a LINE, not a release: floor (fhevm v0.13.0) to ceiling (the vendored release).
contract LibFhevmVersionTest is Test {
    ...
    function test_theWholeLineIsAcceptedAndNothingElse() public pure {
        ...
        assertFalse(LibFhevmVersion.accepts("FHEVMExecutor v0.3.0", FLOOR, CEILING), "the 0.12 line");
    ...
    /// The floors are the 0.13.0 tag, and every generated ceiling lies on or above its floor: a regeneration
    ...
    function test_theFloorsAndCeilingsDescribeOneLine() public pure {
        _line(LibFhevmVersion.ACL_FLOOR, "ACL v0.4.0", LocalHostVersions.ACL);
        _line(LibFhevmVersion.FHEVM_EXECUTOR_FLOOR, "FHEVMExecutor v0.4.0", LocalHostVersions.FHEVM_EXECUTOR);
        _line(LibFhevmVersion.INPUT_VERIFIER_FLOOR, "InputVerifier v0.2.0", LocalHostVersions.INPUT_VERIFIER);
        _line(LibFhevmVersion.KMS_VERIFIER_FLOOR, "KMSVerifier v0.3.0", LocalHostVersions.KMS_VERIFIER);
        _line(LibFhevmVersion.PROTOCOL_CONFIG_FLOOR, "ProtocolConfig v0.1.0", LocalHostVersions.PROTOCOL_CONFIG);
    }
