...
contract SimpleMultiSig is ZamaEthereumConfig {
    struct Transaction {
        address target;
        bytes data;
    }
    ...
    function executeSpecialTx(address encryptedSetter) external {
        ...
        IEncryptedSetter(encryptedSetter)
            .setEncryptedValue(externalEuint64.wrap(euint64.unwrap(uninitializedHandle)), hex"");
    }
