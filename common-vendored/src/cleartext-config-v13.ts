...
//
// The v13 TypeScript face: every constant v13 has a field for, in declaration order — the shared set
// plus what the JSON scopes to v13 with `generations`. The JSON is THE source of truth for every value the
...
// v13's `pkg/src/cleartext/shared/LibFhevmCleartextConfig.sol` is the same JSON's Solidity face.
//
