...
describe('FHEVM manual operations using userDecrypt', function () {
  ...
  it('Select works returning if false', async function () {
    ...
    await tx.wait();
    const res = await fhevm.helpers.decryptUint32({
      euint32: (await contract.resEuint32()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
  ...
  it('Select ebool', async function () {
    ...
    await tx.wait();
    const res = await fhevm.helpers.decryptBool({
      ebool: (await contract.resEbool()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
    ...
    await tx2.wait();
    const res2 = await fhevm.helpers.decryptBool({
      ebool: (await contract.resEbool()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
  ...
  it('Select works for eaddress returning if false', async function () {
    ...
    await tx.wait();
    const res = await fhevm.helpers.decryptAddress({
      eaddress: (await contract.resAdd()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
  ...
  it('ebool eq ebool', async function () {
    ...
    await tx3.wait();
    const res3 = await fhevm.helpers.decryptBool({
      ebool: (await contract.resEbool()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
    ...
    await tx4.wait();
    const res4 = await fhevm.helpers.decryptBool({
      ebool: (await contract.resEbool()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
  ...
  it('ebool to euint8 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.helpers.decryptUint8({
      euint8: (await contract.resEuint8()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
  ...
  it('ebool to euint16 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.helpers.decryptUint16({
      euint16: (await contract.resEuint16()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
    expect(res).to.equal(1);
  ...
  it('ebool to euint64 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.helpers.decryptUint64({
      euint64: (await contract.resEuint64()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
  ...
  it('ebool to euint128 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.helpers.decryptUint128({
      euint128: (await contract.resEuint128()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
    expect(res).to.equal(1n);
  ...
  it('ebool to euint256 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.helpers.decryptUint256({
      euint256: (await contract.resEuint256()) as Hex,
      contractAddress: contractAddress,
      userAddress: signers.alice.address,
    });
    expect(res).to.equal(1n);
