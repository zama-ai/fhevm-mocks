...
contract FhevmCleartextEventProcessorTest is Test, FhevmCleartextDeploy {
    ...
    function setUp() public {
        ...
        processor = new FhevmCleartextEventProcessor(FHEVM_EXECUTOR_ADDRESS);
    ...
    function test_theWriterSetIsFixed() public {
        ...
        FhevmCleartextEventProcessorDB store = processor.db();

        vm.expectRevert(FhevmCleartextEventProcessorDB.CleartextEventWriterSetIsFixed.selector);
    ...
    function test_randComesFromTheUpstream() public {
        ...
        assertTrue(processor.statusOf(r) != FhevmCleartextEventProcessorDB.Status.NonReplayable);
    ...
    function test_randIsMarkedWhenThereIsNoUpstream() public {
        FhevmCleartextEventProcessor p = new FhevmCleartextEventProcessor(address(new OtherChainExecutor()));
        ...
        assertTrue(p.statusOf(r) == FhevmCleartextEventProcessorDB.Status.NonReplayable);
    }
    ...
    function test_aSeededRandomHandleBecomesUsable() public {
        ...
        assertTrue(processor.statusOf(r) == FhevmCleartextEventProcessorDB.Status.Known);
    ...
    function test_anUnprocessedHandleComesFromTheUpstream() public {
        ...
        assertTrue(processor.statusOf(stranger) == FhevmCleartextEventProcessorDB.Status.Unset);
    ...
    function test_aHandleNobodyHasIsRefused() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FhevmCleartextEventProcessorDB.CleartextEventUnknownHandle.selector, stranger)
        );
    ...
    function test_aForeignHandleStartsUnknown() public {
        ...
        assertTrue(processor.statusOf(foreign) == FhevmCleartextEventProcessorDB.Status.Unset);

        vm.expectRevert(
            abi.encodeWithSelector(FhevmCleartextEventProcessorDB.CleartextEventUnknownHandle.selector, foreign)
        );
    ...
    function test_unknownHandlesRevertByDefault() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FhevmCleartextEventProcessorDB.CleartextEventUnknownHandle.selector, sepoliaBalance)
        );
    ...
    function test_aSeededHandleBeatsThePolicy() public {
        ...
        assertTrue(processor.statusOf(h) == FhevmCleartextEventProcessorDB.Status.Known);
    }
    ...
    function test_aDuplicateExecutorIsRefused() public {
        vm.expectRevert(
            abi.encodeWithSelector(
                FhevmCleartextEventProcessor.CleartextEventDuplicateExecutor.selector, FHEVM_EXECUTOR_ADDRESS
            )
        );
    ...
    function test_aNullExecutorIsRefused() public {
        vm.expectRevert(FhevmCleartextEventProcessor.CleartextEventNullExecutor.selector);
    ...
    function test_eachExecutorKeepsItsOwnStore() public {
        ...
        assertTrue(
            processor.dbOf(address(other)).statusOf(here) == FhevmCleartextEventProcessorDB.Status.Unset,
            "not in the other store"
        );
        assertTrue(
            processor.dbOf(FHEVM_EXECUTOR_ADDRESS).statusOf(there) == FhevmCleartextEventProcessorDB.Status.Unset,
            "nor the reverse"
        );
    ...
    function test_selectingAnExecutorSurvivesAReplay() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FhevmCleartextEventProcessorDB.CleartextEventUnknownHandle.selector, here)
        );
    ...
    function test_policyIsPerExecutor() public {
        ...
        FhevmCleartextEventProcessorDB otherStore = processor.dbOf(address(other));
    ...
    function test_anUnknownExecutorHasNoStore() public {
        vm.expectRevert(
            abi.encodeWithSelector(FhevmCleartextEventProcessor.CleartextEventUnknownExecutor.selector, address(0xBEEF))
        );
    ...
    function test_anUnregisteredEmitterIsIgnored() public {
        ...
        assertTrue(processor.statusOf(h) == FhevmCleartextEventProcessorDB.Status.Unset);
    }
