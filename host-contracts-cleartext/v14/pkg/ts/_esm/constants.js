...
import { CLEARTEXT_COPROCESSOR_COUNT, CLEARTEXT_COPROCESSOR_THRESHOLD, CLEARTEXT_DECRYPTION_ADDRESS, CLEARTEXT_GATEWAY_CHAIN_ID, CLEARTEXT_HCU_CAP_PER_BLOCK, CLEARTEXT_INPUT_VERIFICATION_ADDRESS, CLEARTEXT_KMS_NODE_COUNT, CLEARTEXT_KMS_NODE_IP_ADDRESS_PREFIX, CLEARTEXT_KMS_NODE_STORAGE_URL_PREFIX, CLEARTEXT_MAX_HCU_DEPTH_PER_TX, CLEARTEXT_MAX_HCU_PER_TX, } from './cleartext-config.js';
import { CLEARTEXT_KMS_NODE_CA_CERT, CLEARTEXT_KMS_NODE_MPC_IDENTITY_INFIX, CLEARTEXT_KMS_NODE_MPC_IDENTITY_PREFIX, CLEARTEXT_KMS_NODE_PUBLIC_STORAGE_PREFIX, CLEARTEXT_KMS_SOFTWARE_VERSION, } from './cleartext-config-v14.js';
 ...
 * two types.
 */
export const DEFAULT_KMS_THRESHOLDS = {
...
export function generateFromExistingDefaultKmsNodes(existingSigners) {
 ...
 */
export function nextDefaultKmsSignerWindow(currentSigners) {
