...
// v14's KMS rotation types live with the lifecycle code; re-exported here so consumers see one type module.
export type {
  EpochActivationAttestation,
  EpochActivationDigests,
  KeyDigest,
  KmsEpochActivator,
} from '../kmsLifecycle/types.js';
