...
void test('js-sdk cleartext signer config matches host-contracts-cleartext/v14 constants', () => {
  ...
  assert.equal(
    ...
    'mnemonic mismatch between js-sdk and host-contracts-cleartext/v14',
  );
