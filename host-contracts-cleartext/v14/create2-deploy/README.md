...
| [script/FhevmUpgradeBase.s.sol](script/FhevmUpgradeBase.s.sol) | upgrade plan §5–§6 | the upgrade's 7-create and 7-op role/artifact tables |
| [script/FhevmComputeUpgradeAddresses.s.sol](script/FhevmComputeUpgradeAddresses.s.sol) | upgrade plan §4 | two-pass computation over the eleven live addresses; v14 creates no proxy |
| [script/FhevmUpgradeCreates.s.sol](script/FhevmUpgradeCreates.s.sol) | upgrade plan §5 | the seven resumable factory CREATE2 calls |
