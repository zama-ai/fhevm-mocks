...
Start anvil and deploy the cleartext v14 stack onto it with no Solidity
...
main() {
    ...
    echo ""
    echo "🚀 deploying the cleartext v14 stack (setCode + one atomic ACLOwner.upgrade, no solc)"
